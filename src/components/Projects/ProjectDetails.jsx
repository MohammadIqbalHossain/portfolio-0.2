...
const ProjectDetails = () => {
  ...
  return (
    <div className='project__details'>
       <h1 className='project__details-title' style={{'--font-size': '95px', '--text-transform': 'capitalize'}}>{filteredProject[0].projectName}</h1>
       <h2 className='project__path'>Breath in space.</h2>

       <div className='project__banner-image' 
          style={{
       ...
       <div className='project__action-btns'>
        ...
        <button className='project__action-btn github__client-btn' role='button'>
          <a href="#">GitHub→ Front-End
          <RxExternalLink />
          </a>
        </button>
        <button className='project__action-btn github__server-btn' role='button'>
        <a href="#">GitHub→ Back-End
        <RxExternalLink />
        </a>
        </button>
       </div>
       ...
       <div className='card-container'>
          ...
          <div className='project__details-card'  style={{
            '--image': `url(${image2})`,
            '--angle': '-1deg',
            '--x': '10%',
            '--y': '20%',
      ...
      <div>
        <h2 className='project__details-title' style={{'--font-size': '15px', '--text-transform': 'capitalize'}}>Technologies Used: </h2>
      </div>
      ...
      <div className='project__tech-stack'>
          ...
          <div className='project__tech tech'>
          <img width="100" height="100" src="https://img.icons8.com/color/48/tailwind_css.png" alt="tailwind_css"/>
          </div>
          <div className='project__tech tech'>
