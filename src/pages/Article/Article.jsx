...
const Article = () => {
  ...
  return (
    <section className='blog__section-container'>
      {
      article.map((blog) => <article key={blog.index} className='blog__container'>
     <h2>{blog.index}</h2>
      <div className='blog'>
         <div className='blog__header'>
           <p className='blog__category'>#{blog.category}</p>
           <button className='project__action-btn blog__read-btn' role='button'>
