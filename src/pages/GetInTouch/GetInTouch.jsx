        ...
        speaker={
          <Popover arrow={true}>
            ...
            <div className="popover-content">
              {/* Instagram */}
              <Link to="https://www.instagram.com/_being.iqbal/" target="__blank">
              ...
              {/* Facebook */}
              <Link to="https://web.facebook.com/iqbal.abdullah.927543/" target="__blank">
                <div className="social-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
              ...
              {/* X Twitter */}
              <Link to="https://x.com/IQBAL96993312" target='__blank'>
                <div className="social-icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
             ...
             <a className="mail" href="mailto:being.iqbal.hossain@gmail.com?subject=Hello%20Iqbal&body=I%20would%20like%20to%20get%20in%20touch%20with%20you">being.iqbal.hossain@gmail.com</a>
            </div>
          </Popover>
        }
      >
